                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            <img src="{{ asset('build/images/logo-simon.png') }}" alt=""
                                    ...
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            <form method="POST" class="form-horizontal">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('nik') }}" id="nik" nik="nik" autofocus
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number"
                                                        ...
                                                        id="usermobile" value="{{ old('mobile') }}" name="mobile"
                                            ...
                                            <div class="mt-3 text-center">
                                                <p>Already have an account ? <a href="{{ route('auth.login') }}"
