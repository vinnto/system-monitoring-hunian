                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table align-middle dt-responsive nowrap w-100 table-check">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $tempat_tinggals; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tempat_tinggal): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($tempat_tinggal->id); ?></td>
                                        <td><?php echo e($tempat_tinggal->tempat_tinggal); ?></td>
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
                                                <button class="btn btn-sm btn-soft-success edit-btn" data-bs-toggle="modal"
                                                    data-bs-target="#editTempatTinggalModal"data-id="<?php echo e($tempat_tinggal->id); ?>"
                                                    data-tempat_tinggal="<?php echo e($tempat_tinggal->tempat_tinggal); ?>"
                                                    data-url="<?php echo e(route('tempat-tinggal.update', $tempat_tinggal->id)); ?>">
                                                    <i class="bx bx-edit font-size-20"></i>
                                                </button>
                                                <button class="btn btn-sm btn-soft-danger delete-btn" data-bs-toggle="modal"
                                                    data-bs-target="#deleteTempatTinggalModal" data-id="<?php echo e($tempat_tinggal->id); ?>"
                                                    data-url="<?php echo e(route('tempat-tinggal.destroy', $tempat_tinggal->id)); ?>">
    ...
    <div class="modal fade" id="addTempatTinggalModal" tabindex="-1" aria-labelledby="addTempatTinggalModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="addTempatTinggalForm" action="<?php echo e(route('tempat-tinggal.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('js/master/tempat-tinggal.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\system-monitoring-hunian\resources\views/pages/admin/master/list-tempat-tinggal.blade.php ENDPATH**/ ?>