                                ...
                                <div class="d-flex flex-column h-100">
                                    <div class="mb-4 mb-md-5">
                                        <a href="index" class="d-block auth-logo">
                                            ...
                                            <img src="<?php echo e(asset('build/images/logo-simon.png')); ?>" alt=""
                                                height="50px" width="90px" class="auth-logo-light">
                                        </a>
                                    </div>
                                    <div class="my-auto">
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <div class="mt-5 text-center">
                                                <p>Remember It ? <a href="<?php echo e(route('auth.login')); ?>"
                                                        class="fw-medium text-primary"> Sign
                                                        In here</a> </p>
                                            </div>
                                        </div>
                                    </div>
...
<?php echo $__env->make('layouts.master-without-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\system-monitoring-hunian\resources\views/auth/passwords/forgot-password.blade.php ENDPATH**/ ?>