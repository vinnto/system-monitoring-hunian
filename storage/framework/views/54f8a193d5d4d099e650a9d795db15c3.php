                        ...
                        <table class="table align-middle dt-responsive nowrap w-100 table-check">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $lokasis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lokasi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td><?php echo e($lokasi->id); ?></td>
                                        <td><?php echo e($lokasi->lokasi); ?></td>
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
                                                <button class="btn btn-sm btn-soft-success edit-btn" data-bs-toggle="modal"
                                                    data-bs-target="#editLokasiModal"data-id="<?php echo e($lokasi->id); ?>"
                                                    data-lokasi="<?php echo e($lokasi->lokasi); ?>"
                                                    data-url="<?php echo e(route('lokasi.update', $lokasi->id)); ?>">
                                                    <i class="bx bx-edit font-size-20"></i>
                                                </button>
                                                <button class="btn btn-sm btn-soft-danger delete-btn" data-bs-toggle="modal"
                                                    data-bs-target="#deleteLokasiModal" data-id="<?php echo e($lokasi->id); ?>"
                                                    data-url="<?php echo e(route('lokasi.destroy', $lokasi->id)); ?>">
    ...
    <div class="modal fade" id="addLokasiModal" tabindex="-1" aria-labelledby="addLokasiModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form id="addLokasiForm" action="<?php echo e(route('lokasi.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
<?php $__env->startSection('script'); ?>
    ...
    <script src="<?php echo e(asset('js/master/lokasi.js')); ?>"></script>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laragon\www\system-monitoring-hunian\resources\views/pages/admin/master/list-lokasi.blade.php ENDPATH**/ ?>