        ...
        <div class="d-flex">
            ...
            <div class="navbar-brand-box">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-dark">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo-simon.png')); ?>" alt="" height="17">
                    </span>
                </a>
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="logo logo-light">
                    ...
                    <span class="logo-lg">
                        <img src="<?php echo e(URL::asset('build/images/logo-simon.png')); ?>" alt="" height="50px" width="100px ">
                    </span>
                </a>
            </div>
...
<?php /**PATH C:\laragon\www\system-monitoring-hunian\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>